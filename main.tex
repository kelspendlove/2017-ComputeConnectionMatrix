...
\input{connectionMatrix}




\input{chainFibrations}
\input{coherentChainFibrations}

\input{homotopyCategory}
...
\newblock{\em Transactions of the AMS}, 298(1):193–213 (1986).

\bibitem{fran3}
R.~Franzosa.
\newblock{The continuation theory for Morse decompositions and connection matrices},
\newblock{\em Transactions of the AMS}, 310(2):781–803 (1988).
...
%\newblock{Morse–Conley–Floer homology. Journal of Topology and Analysis, 6(03), pp.305-338.}
%
%\bibitem{rvII}
%Rot, T.O. and Vandervorst, R.C.A.M., 2014. 
%\newblock{Functoriality and duality in Morse–Conley–Floer homology. Journal of Fixed Point Theory and Applications, 16(1-2), pp.437-476.}
