...
We label the category of graded module braids over $(P,\leq)$ by ${\bf GB}(P,\leq)$.  Implicit in~\cite{fran} is the description of a functor from $\cH:{\bf CCB}(P,\leq)\to {\bf GB}(P,\leq)$ which is the analogy of the homology functor.  This is basically the content of~\cite[Proposition 2.7]{fran}.
